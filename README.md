...
<svg xmlns="http://www.w3.org/2000/svg" width="495" height="195" viewBox="0 0 495 195" fill="none" role="img" aria-labelledby="descId">
        <title id="titleId">SlidexDE's GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 5, Total Commits in 2022 : 5, Total PRs: 0, Total Issues: 5, Contributed to: 5</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 127.86499252087239;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text x="0" y="0" class="header" data-testid="header">SlidexDE's GitHub Stats</text>
    </g>
      </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="stars">5</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="commits">38</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="issues">5</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="contribs">5</text>
    </g>
  </g>
    </svg> 
